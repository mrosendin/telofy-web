      ...
      <section id="app-preview" className="py-16 sm:py-24 border-t border-telofy-border">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">Available on iOS, Android & Web</h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8 sm:gap-12">
            ...
            {/* iPhone Mockup 2 */}
            <div className="iphone-frame hidden sm:block">
              <div className="iphone-notch" />
              <div className="iphone-screen">
                <Image 
                  src="/app-screenshot-2.png" 
                  alt="Telofy Tasks Screen" 
                  width={280} 
                  height={606}
                  className="object-cover object-top"
                />
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mt-10">
            ...
            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-telofy-surface border border-telofy-border">
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                <path d="M17.523 2.473a.75.75 0 010 1.06l-1.444 1.444a7.5 7.5 0 01-8.818 11.674l-2.05 2.05a.75.75 0 01-1.06-1.06l2.05-2.05A7.5 7.5 0 0117.875 4.773l1.648-1.3a.75.75 0 011.06 0zM6.914 9.97a5.25 5.25 0 007.116 7.116l1.592-1.592a5.25 5.25 0 00-7.116-7.116L6.914 9.97z"/>
              </svg>
